...
import '../video_player/tv_guide_overlay_layout.dart';

class TvGuidePlayerWidgetFactory extends StatefulWidget
    implements VideoPlayerFactory {
  VideoPlayerController videoPlayerController;

  TvGuidePlayerWidgetFactory(
      {Key? key, required this.videoPlayerController})
      : super(key: key);

  @override
  State<TvGuidePlayerWidgetFactory> createState() =>
      _CompleteVideoPlayerWidgetState(videoPlayerController);

  @override
  Widget build(BuildContext? context) {
    return _CompleteVideoPlayerWidgetState(videoPlayerController)
        .build(context!);
  }
}

class _CompleteVideoPlayerWidgetState
    extends State<TvGuidePlayerWidgetFactory> {
